...
interface
uses
  System.Classes, System.SysUtils, Winapi.Windows, Vcl.Graphics, HGETextures,
  WIL;
...
function TWMM3ZipImages.CopyImageDataToTexture(Buffer: PAnsiChar; Texture: TDXImageTexture; Width, Height: Word): Boolean;
var
  Y: Integer;
