...
begin
  rect:=HGErct.SetRect(X - FHotX,Y - FHotY,X - FHotX + FWidth,Y - FHotY + FHeight);
  Result := @Rect;
end;
...
begin
  ...
  if (Rot <> 0.0) then begin
    ...
    rect:=HGErct.Encapsulate (Rect,TX1 * CosT - TY1 * SinT + X,TX1 * SinT + TY1 * CosT + Y);
    rect:=HGErct.Encapsulate(Rect,TX2 * CosT - TY1 * SinT + X,TX2 * SinT + TY1 * CosT + Y);
    rect:=HGErct.Encapsulate(Rect,TX2 * CosT - TY2 * SinT + X,TX2 * SinT + TY2 * CosT + Y);
    rect:=HGErct.Encapsulate(Rect,TX1 * CosT - TY2 * SinT + X,TX1 * SinT + TY2 * CosT + Y);
  end else begin
    rect:=HGErct.Encapsulate(Rect,TX1 + X, TY1 + Y);
    rect:=HGErct.Encapsulate(Rect,TX2 + X, TY1 + Y);
    rect:=HGErct.Encapsulate(Rect,TX2 + X, TY2 + Y);
    rect:=HGErct.Encapsulate(Rect,TX1 + X, TY2 + Y);
  end;
