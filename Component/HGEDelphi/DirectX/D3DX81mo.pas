...
type
  TD3DXCreateTexture = function(Device: IDirect3DDevice9; Width, Height, MipLevels: Cardinal; Usage: LongWord; Format: TD3DFormat; Pool: TD3DPool; out Texture: IDirect3DTexture9): HResult; stdcall;
  ...
  TD3DXSaveSurfaceToFile = function(DestFile: PAnsiChar; const DestFormat: TD3DXImageFileFormat; SrcSurface: IDirect3DSurface9; SrcPalette: PPaletteEntry; SrcRect: PRect): HResult; stdcall;
