...
begin
  ...
  nBeginaddr := inet_addr(PAnsiChar(AnsiString(sIPaddress)));
  ...
  nEndaddr := inet_addr(PAnsiChar(AnsiString(sIPaddress)));
...
begin
  if (ListBoxActiveList.ItemIndex >= 0) and (ListBoxActiveList.ItemIndex <
    ...
    ListBoxTempList.Items.Add(sIPaddr);
    New(IPaddr);
    IPaddr.nIPaddr := inet_addr(PAnsiChar(AnsiString(sIPaddr)));
