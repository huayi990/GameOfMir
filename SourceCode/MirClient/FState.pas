...
uses
  Windows, SysUtils, StrUtils, Classes, Messages, Graphics, Controls, Forms,
  Dialogs, HGEBase, DES, HGE, HGEGUI, HGETextures, Grids, Grobal2, ClFunc,
  HUtil32, FindMapPath, SoundUtil, IntroScn, MShare, DateUtils, Direct3D9,
  MudUtil;
