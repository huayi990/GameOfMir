...
//    m_DefMsg: TDefaultMessage;
    ...
    procedure SendSocket(Socket: TCustomWinSocket; SendBuff: PAnsiChar; BuffLen: Integer);
    procedure LoadHumanRcd(RecvBuff: PAnsiChar; BuffLen, QueryID: Integer; Socket: TCustomWinSocket);
    ...
    //    procedure GetSortList(sMsg: string; nRecog: Integer; Socket:
         // TCustomWinSocket);
    procedure SaveHumanRcd(nRecog, QueryID: Integer; RecvBuff: PAnsiChar; BuffLen: Integer; Socket: TCustomWinSocket);
...
procedure TFrmDBSrv.SendSocket(Socket: TCustomWinSocket; SendBuff: PAnsiChar; BuffLen: Integer);
//0x004A8764
var
  nCheckCode: Integer;
  //s18: string;
...
procedure TFrmDBSrv.LoadHumanRcd(RecvBuff: PAnsiChar; BuffLen, QueryID: Integer; Socket: TCustomWinSocket);
var
  sHumName: string;
  sAccount: string;
  sIPaddr: string;
...
procedure TFrmDBSrv.SaveHumanRcd(nRecog, QueryID: Integer; RecvBuff: PAnsiChar; BuffLen: Integer; Socket: TCustomWinSocket);
var
  sChrName: string;
  sUserId: string;
  //  sHumanRCD: string;
