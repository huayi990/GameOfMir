...
type
  ...
  TSetProc = function(ProcAddr: Pointer; ProcName: PAnsiChar; nNameLen: Integer):
    Boolean; stdcall;
  ...
  TPlugLoad = function(AppHandle: HWnd; MsgProc: TMsgProc; FindProc: TFindProc;
    SetProc: TSetProc; FindOBj: TFindObj; LoadMode: Boolean): PAnsiChar; stdcall;
  TClassProc = procedure(Sender: TObject);
  TStartProc = procedure(); stdcall;
  TStartRegister = function(sRegisterInfo, sUserName: PAnsiChar): Integer; stdcall;
  ...
  TDeCryptString = procedure(Src, Dest: PAnsiChar; nSrc: Integer; var nDest: Integer); stdcall;
